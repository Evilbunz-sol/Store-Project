  ...
  return (
    <section className="h-screen grid place-items-center">
      <Form method="POST" className="card w-96 p-8 bg-base-100 shadow-lg flex flex-col gap-y-4">
        ...
        <FormInput type="text" label="username" name="username" defaultValue="jameel1" ></FormInput>
        <FormInput type="email" label="email" name="email" defaultValue="jameel1@gmail.com"></FormInput>
